...
export class Migration1688114419983 implements MigrationInterface {
  name = 'Migration1688114419983';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      'CREATE TABLE "session" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "place" character varying NOT NULL, "joinLimit" integer NOT NULL, "activityDate" TIMESTAMP NOT NULL, "isParking" boolean NOT NULL, "isShuttle" boolean NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_f55da76ac1c3ac420f444d2ff11" PRIMARY KEY ("id"))'
    );
    await queryRunner.query(
